...
const EarPhones = () => {
  ...
  return (
   ...
   <Box>
        ...
        <Box>
          <Box>
          <Typography variant='h4' fontWeight="bold">Earphones for you!</Typography>
          </Box>
